...
3. Check logs for a specific service: `docker logs <container_name>`
4. Inspect container config: `docker inspect <container_name>`
...
- If a container is not running, check `docker ps -a` to see stopped containers and their exit codes.
